\begin{tikzpicture}[remember picture,overlay]
    ...
    \shade[bottom color=cw1, top color=cw2!70, opacity=0.65] ([xshift=.5\outermarginwidth]current page.north west) rectangle (current page.south east);
...
\scalebox{6.5}{\fontencoding{T1}\fontfamily{pag}\selectfont\color{cw2}\textbf{MATEMÁTICO}}\\[2cm]
